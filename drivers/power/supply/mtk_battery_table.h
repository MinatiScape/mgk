...
/* pri BLE115S2-1 modify by suwenwei 20240402 start */
/* Qmax for battery  */
int g_Q_MAX[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4964, 2712, 2490, 1965},/*T0*/
	{ 4951, 2851, 2468, 1984},/*T1*/
	{ 4924, 2432, 2310, 1946},/*T2*/
	{ 4875, 1991, 1858, 1873},/*T3*/
	{ 4733, 1960, 1843, 1851},/*T4*/
	{ 4928, 1652, 1533, 1541},/*T5*/
	{ 2201, 1642, 1523, 1531},/*T6*/
	{ 2191, 1632, 1513, 1521},/*T7*/
	{ 2181, 1622, 1503, 1511},/*T8*/
	{ 2171, 1612, 1493, 1501} /*T9*/
};
/* pri BLE115S2-1 modify by suwenwei 20240402 end */

int g_Q_MAX_H_CURRENT[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4853, 2412, 2190, 1665},/*T0*/
	{ 5043, 2551, 2168, 1684},/*T1*/
	{ 5022, 2132, 2010, 1646},/*T2*/
	{ 4812, 1691, 1558, 1573},/*T3*/
	{ 4345, 1660, 1543, 1551},/*T4*/
	{ 3764, 1650, 1533, 1541},/*T5*/
