...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx,0xD9,0x00,0xC2,0xC2);  //VCOM(-1.5V) 
    ...
    lcm_dcs_write_seq_static(ctx,0x00,0x00);
    lcm_dcs_write_seq_static(ctx,0xE1,0x0D,0x12,0x21,0x30,0x38,0x43,0x53,0x60,0x62,0x6E,0x70,0x85,0x7E,0x6A,0x6A,0x5F);
    lcm_dcs_write_seq_static(ctx,0x00,0x10);
    lcm_dcs_write_seq_static(ctx,0xE1,0x57,0x4B,0x3B,0x32,0x29,0x1B,0x10,0x0F);

    lcm_dcs_write_seq_static(ctx,0x00,0x00);
    lcm_dcs_write_seq_static(ctx,0xE2,0x0D,0x12,0x21,0x30,0x38,0x43,0x53,0x60,0x62,0x6E,0x70,0x85,0x7E,0x6A,0x6A,0x5F);
    lcm_dcs_write_seq_static(ctx,0x00,0x10);
    lcm_dcs_write_seq_static(ctx,0xE2,0x57,0x4B,0x3B,0x32,0x29,0x1B,0x10,0x0F);
    ...
    //CGOUTL
    lcm_dcs_write_seq_static(ctx,0x00,0x80);
    lcm_dcs_write_seq_static(ctx,0xCC,0x26,0x1C,0x26,0x26,0x26,0x1D,0x01,0x00,0x00,0x07,0x09,0x0B,0x0D,0x0F,0x11,0x03);
    ...
    //CGOUTR
    lcm_dcs_write_seq_static(ctx,0x00,0x80);
    lcm_dcs_write_seq_static(ctx,0xCD,0x26,0x1C,0x26,0x26,0x26,0x1D,0x01,0x00,0x00,0x06,0x08,0x0A,0x0C,0x0E,0x10,0x02);
    ...
    //CGOUTL
    lcm_dcs_write_seq_static(ctx,0x00,0xA0);
    lcm_dcs_write_seq_static(ctx,0xCC,0x26,0x26,0x1C,0x26,0x26,0x1D,0x01,0x00,0x00,0x08,0x06,0x10,0x0E,0x0C,0x0A,0x04);
    ...
    //CGOUTR
    lcm_dcs_write_seq_static(ctx,0x00,0xA0);
    lcm_dcs_write_seq_static(ctx,0xCD,0x26,0x26,0x1C,0x26,0x26,0x1D,0x01,0x00,0x00,0x09,0x07,0x11,0x0F,0x0D,0x0B,0x05);
...
//drv-mod by shenwenbin for hardware info 20240508 start	
    ...
    strcpy(current_lcm_info.vendor,"XTALPI");
    sprintf(current_lcm_info.id,"0x%02x",0x18);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "xtalpi,ft8057s,vdo,90hz", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-sky-ft8057s-vdo-dphy-xtalpi-90hz",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("sky ft8057s VDO LCD Panel Driver");
