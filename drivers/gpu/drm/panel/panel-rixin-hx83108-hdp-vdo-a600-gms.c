...
lcm_dcs_write_seq_static(ctx,0xB1,0x2C,0x35,0x35,0x29,0x31,0x20,0x4D,0x2F,0x1A,0x1A,0x0C,0x98,0x21,0x11,0x46,0x77,0x64,0x24);
lcm_dcs_write_seq_static(ctx,0xB2,0x00,0x26,0xD0,0x40,0x00,0x24,0xC6,0x20,0x64,0x11,0x01,0x00,0x33,0x55,0x22,0xDF);
lcm_dcs_write_seq_static(ctx,0xB4,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x02,0x59,0x01,0x02);
//lcm_dcs_write_seq_static(ctx,0xB6,0x30,0x30,0x00);	//VCOM
...
lcm_dcs_write_seq_static(ctx,0xE9,0xD0);
lcm_dcs_write_seq_static(ctx,0xBB,0x38);
lcm_dcs_write_seq_static(ctx,0xE9,0x3F);
...
lcm_dcs_write_seq_static(ctx,0xCB,0x13,0x08,0xE0,0x09,0x98);
lcm_dcs_write_seq_static(ctx,0xD1,0x27,0x02);
lcm_dcs_write_seq_static(ctx,0xD2,0x00,0x00,0x00,0x00);
lcm_dcs_write_seq_static(ctx,0xD3,0xC0,0x00,0x10,0x10,0x00,0x00,0x3F,0x3F,0x33,0x3B,0x23,0x23,0x23,0x23,0x32,0x10,0x1E,0x00,0x1E,0x32,0x17,0x24,0x07,0x24,0x32,0x10,0x19,0x00,0x19,0x00,0x00);
lcm_dcs_write_seq_static(ctx,0xD5,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x41,0x41,0x28,0x29,0x18,0x18,0x18,0x18,0x20,0x21,0x0E,0x0F,0x0C,0x0D,0x0A,0x0B,0x08,0x09,0x06,0x07,0x04,0x05,0x02,0x03,0x00,0x01);
lcm_dcs_write_seq_static(ctx,0xD6,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x41,0x41,0x28,0x29,0x18,0x18,0x18,0x18,0x20,0x21,0x0E,0x0F,0x0C,0x0D,0x0A,0x0B,0x08,0x09,0x06,0x07,0x04,0x05,0x02,0x03,0x00,0x01);
...
lcm_dcs_write_seq_static(ctx,0xE0,0x00,0x01,0x05,0x09,0x0D,0x0B,0x1B,0x1E,0x23,0x1E,0x37,0x3D,0x43,0x54,0x54,0x5F,0x6B,0x82,0x86,0x45,0x50,0x5F,0x73,0x00,0x01,0x05,0x09,0x0D,0x0B,0x1B,0x1E,0x23,0x1E,0x37,0x3D,0x43,0x54,0x54,0x5F,0x6B,0x82,0x86,0x45,0x50,0x5F,0x73);
lcm_dcs_write_seq_static(ctx,0xE7,0x11,0x14,0x14,0x01,0x0F,0x84,0x00,0x3C,0x3C,0x32,0x32,0x00,0x00,0x00,0x00,0xCC,0x10,0x01,0x02);
...
lcm_dcs_write_seq_static(ctx,0xE9,0xC6);
lcm_dcs_write_seq_static(ctx,0xD2,0x18,0x2C);
lcm_dcs_write_seq_static(ctx,0xE9,0x3F);
...
lcm_dcs_write_seq_static(ctx,0xD8,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0);
lcm_dcs_write_seq_static(ctx,0xBD,0x00);	
...
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
    strcpy(current_lcm_info.chip,"hx83108_gms");
    strcpy(current_lcm_info.vendor,"rixin");
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "rixin,hx83108-gms,vdo", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-rixin-hx83108-hdp-vdo-a600-gms",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("sc hx83108 VDO LCD Panel Driver");
