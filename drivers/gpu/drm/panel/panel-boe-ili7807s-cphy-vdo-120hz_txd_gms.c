...
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
    strcpy(current_lcm_info.chip,"ili7807s,cphy,vdo,txd,gms");
    strcpy(current_lcm_info.vendor,"tongxingda,boe");
    sprintf(current_lcm_info.id,"0x%04x",0x7807);
    strcpy(current_lcm_info.more,"1080*2460");
#endif

	pr_info("%s- boe,ili7807s,cphy,vdo,120hz,txd,gms\n", __func__);
...
static const struct of_device_id lcm_of_match[] = {
	{
	    .compatible = "boe,ili7807s,cphy,vdo,120hz,txd,gms",
	},
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-boe-ili7807s-cphy-vdo-120hz_txd_gms",
		.owner = THIS_MODULE,
