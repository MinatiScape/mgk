...
//drv-mod by shenwenbin for hardware info 20240508 start	
    ...
    strcpy(current_lcm_info.vendor,"SKYWORTH");
    sprintf(current_lcm_info.id,"0x%02x",0x15);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "skyworth,ft8057s,vdo,90hz", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-sky-ft8057s-vdo-dphy-90hz",
		.owner = THIS_MODULE,
