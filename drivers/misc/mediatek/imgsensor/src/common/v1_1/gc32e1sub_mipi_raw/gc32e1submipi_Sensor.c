 ...
 */
#define PFX "gc32e1sub_camera_sensor"
...
#include "gc32e1submipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc32e1sub_camera_sensor"
#define LOG_1 LOG_INF("GC32E1SUB, MIPI 4LANE\n")
/****************************   Modify end    *******************************************/
#define GC32E1SUB_DEBUG                1
#if GC32E1SUB_DEBUG
...
/* prize add by chenwenhui 20240220 for remosiac start */
//#define GC32E1SUB_REMOSAIC
/* prize add by chenwenhui 20240220 for remosiac end */
...
kal_uint16 gc32e1sub_init_addr_data[] = {
	0x0315, 0xc0,
	0x0c10, 0x1b,
	0x01a7, 0x02,
	0x01aa, 0x05,
...
static kal_uint16 gc32e1sub_3264x2448_30fps_addr_data[] = {
	0x031c, 0x60,
	0x0315, 0xd3,
	0x01a9, 0x35,
	0x0c0c, 0x48,
...
static kal_uint16 gc32e1sub_3264x1840_30fps_addr_data[] = {
	0x031c, 0x60,
	0x0315, 0xd3,
	0x01a9, 0x35,
	0x0c0c, 0x48,
...
#ifdef GC32E1SUB_REMOSAIC
static kal_uint16 gc32e1sub_6528x4896_addr_data[] = {
	//fullsize 15fps 0601
	0x031c, 0x60,
	0x0315, 0xd7,
	0x01a9, 0x5d,
...
static kal_uint16 gc32e1sub_3264x2448_60fps_addr_data[] = {
/*system*/
	0x031c, 0x60, 
	0x0315, 0xd7, 
	0x01a9, 0x61, 
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc32e1sub_init_addr_data,
		sizeof(gc32e1sub_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(gc32e1sub_3264x2448_30fps_addr_data,
	  sizeof(gc32e1sub_3264x2448_30fps_addr_data)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(gc32e1sub_3264x1840_30fps_addr_data,
		sizeof(gc32e1sub_3264x1840_30fps_addr_data)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(gc32e1sub_3264x2448_60fps_addr_data,
		sizeof(gc32e1sub_3264x2448_60fps_addr_data)/sizeof(kal_uint16));
...
{
	pr_debug("[%s] custom1_Start, 6528x4896@30.43fps\n", __func__);
	table_write_cmos_sensor(gc32e1sub_6528x4896_addr_data,
		sizeof(gc32e1sub_6528x4896_addr_data)/sizeof(kal_uint16));
	...
	struct SET_SENSOR_PATTERN_SOLID_COLOR *pdata)
{
	...
	if (modes) {
		...
		if (imgsensor.test_pattern == 5) {
		    ...
		    write_cmos_sensor_8bit(0x008d, 0x10);////default
		} else {
		    write_cmos_sensor_8bit(0x008c, 0x00);
		}
	}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc32e1sub_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_debug("[gc32e1sub_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc32e1sub_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[gc32e1sub_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
