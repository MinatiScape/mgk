...
//drv add by lipengpeng 20231013 start   **************************For dual camera use
  .custom1 = {
   ...
   .custom2 = {
		.pclk = 1331200000,	 /* record different mode's pclk */
		.linelength = 14960,	 /* record different mode's linelength */
		.framelength = 2966, /* record different mode's framelength */
		.startx = 0,
		.starty = 0,			   /* record different mode's starty of grabwindow */
...
//drv add by lipengpeng 20231013 start   **************************For dual camera use
	...
	.sensor_mode_num = 7,			 //support sensor mode num ,don't support Slow motion //drv add by lipengpeng 20231013 start
...
//**************************For dual camera use	
	...
	{8160, 6144, 0, 0, 8160, 6144, 2040, 768,   380, 24,   1280,  720, 0, 0, 1280, 720}, //drv add by lipengpeng 20231013 start
}; 
