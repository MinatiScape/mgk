...
#define S5KJN1_MIRROR_FLIP_ENABLE 0
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	...
	{ 8160, 6144,    0,    0, 8160, 6144, 2040, 1536,60, 228, 1920,  1080,    0,    0, 1920,  1080}, // custom1
...
#define XTC_SIZE (3502)//old version 2612
#define SENSOR_XTC_SIZE (768)
#define PD_XTC_SIZE (4000)
#define SW_GGC_SIZE (626)
#define HW_GGC_SIZE (346)
#define XTC_ADDR (0x0cd5)
#define SENSOR_XTC_ADDR (0x1a83)
#define PD_XTC_ADDR (0x1d83)
#define SW_GGC_ADDR (0x2d23)
#define HW_GGC_ADDR (0x2f95)
	...
	switch (feature_id) 
	{
		...
		case SENSOR_FEATURE_GET_4CELL_DATA:
			...
			switch (*feature_data){
				...
				memcpy(data+SW_GGC_SIZE, &sensor_xtc[0], SENSOR_XTC_SIZE);
				break;
				default:
