 ...
 */
#define PFX "gc32e1tsp_camera_sensor"
...
#include "gc32e1tspmipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc32e1tsp_camera_sensor"
#define LOG_1 LOG_INF("GC32E1TSP, MIPI 4LANE\n")
/****************************   Modify end    *******************************************/
#define GC32E1TSP_DEBUG                1
#if GC32E1TSP_DEBUG
...
/* prize add by chenwenhui 20240426 for remosiac start */
#define GC32E1TSP_REMOSAIC_ENABLE 1
/* prize add by chenwenhui 20240426 for remosiac end */
// Prize add by chenwenhui 20240525 for camera start
#define Module_Id 0x50 // chongqing TSP
#define Eeprom_Addr 0xA4 // chongqing TSP
// Prize add by chenwenhui 20240525 for camera end

static DEFINE_SPINLOCK(imgsensor_drv_lock);


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC32E1TSP_SENSOR_ID,
	.checksum_value = 0x62d29de1,	//Drv: modify for ATA camera test jinzhao 20240222
	.pre = {
		.pclk = 345600000,
		.linelength = 4276,
		.framelength = 2656,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 6528, 4896,0,608, 6528, 3680, 3264, 1840, 0, 0, 3264, 1840, 0, 0, 3264, 1840}, /* video */
...
{
	if(read_eeprom_data_burst(addr, size, data)) {
...
{
	int ret = 0;
	ret |= check_remosaic_data(SXTC_ADDR, SXTC_SIZE, &sxtc[0]);
...
static kal_uint16 read_cmos_sensor_8bit(kal_uint16 addr)
{
	kal_uint16 get_byte = 0;
...
kal_uint16 gc32e1tsp_init_addr_data[] = {
	0x0315, 0xc0,
	0x0c10, 0x1b,
	0x01a7, 0x02,
	0x01aa, 0x05,
...
static kal_uint16 gc32e1tsp_3264x2448_30fps_addr_data[] = {
	0x031c, 0x60,
	0x0315, 0xd3,
	0x01a9, 0x35,
	0x0c0c, 0x48,
...
static kal_uint16 gc32e1tsp_3264x1840_30fps_addr_data[] = {
	0x031c, 0x60,
	0x0315, 0xd3,
	0x01a9, 0x35,
	0x0c0c, 0x48,
...
#if GC32E1TSP_REMOSAIC_ENABLE
static kal_uint16 gc32e1tsp_6528x4896_addr_data[] = {
	//fullsize 15fps 0601
	0x031c, 0x60,
	0x0315, 0xd7,
	0x01a9, 0x5d,
...
static kal_uint16 gc32e1tsp_3264x2448_60fps_addr_data[] = {
/*system*/
	0x031c, 0x60,
	0x0315, 0xd7,
	0x01a9, 0x61,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc32e1tsp_init_addr_data,
		sizeof(gc32e1tsp_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(gc32e1tsp_3264x2448_30fps_addr_data,
	  sizeof(gc32e1tsp_3264x2448_30fps_addr_data)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(gc32e1tsp_3264x1840_30fps_addr_data,
		sizeof(gc32e1tsp_3264x1840_30fps_addr_data)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(gc32e1tsp_3264x2448_60fps_addr_data,
		sizeof(gc32e1tsp_3264x2448_60fps_addr_data)/sizeof(kal_uint16));
...
{
	pr_debug("[%s] custom1_Start, 6528x4896@15fps\n", __func__);
	table_write_cmos_sensor(gc32e1tsp_6528x4896_addr_data,
		sizeof(gc32e1tsp_6528x4896_addr_data)/sizeof(kal_uint16));
	...
	struct SET_SENSOR_PATTERN_SOLID_COLOR *pdata)
{
	...
	if (modes) {
		Blk_Value1 = read_cmos_sensor_8bit(0x008c);
		Blk_Value2 = read_cmos_sensor_8bit(0x008d);
		if (modes == 5) {
		    write_cmos_sensor_8bit(0x008c, 0x01);
		    write_cmos_sensor_8bit(0x008d, 0x00);////black
		} else {
		    write_cmos_sensor_8bit(0x008c, 0x01);////color bar
		}
	} else {
		write_cmos_sensor_8bit(0x008c, Blk_Value1);
		write_cmos_sensor_8bit(0x008d, Blk_Value2);
		Blk_Value1 = 0x0;
		Blk_Value2 = 0x0;
	}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc32e1tsp_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);

#if GC32E1TSP_REMOSAIC_ENABLE
				if (read_remosaic_data())
					pr_debug("init remosaic data failed!\n");
#endif

				return ERROR_NONE;
			}
			pr_debug("[gc32e1tsp_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc32e1tsp_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[gc32e1tsp_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:
		...
		memcpy(data, &sxtc[0], SXTC_SIZE);
		pr_debug("default remosaic data\n");
		break;
#endif
...
UINT32 GC32E1TSP_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
