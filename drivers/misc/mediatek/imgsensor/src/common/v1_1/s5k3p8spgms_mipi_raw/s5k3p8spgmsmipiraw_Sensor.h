 ...
 *
 ****************************************************************************/
#ifndef _S5K3P8SPGMSMIPI_SENSOR_H
#define _S5K3P8SPGMSMIPI_SENSOR_H
...
extern bool read_3P8SP_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);
