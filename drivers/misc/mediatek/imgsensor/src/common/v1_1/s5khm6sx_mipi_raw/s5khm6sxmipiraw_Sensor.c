...
//#define S5KHM6SX_EEPROM_READ_ID  0xA4
...
#define LONG_EXP 0
#define S5KHM6SX_MIRROR_FLIP_ENABLE 1
...
#define LOG_1 LOG_INF("S5KHM6SX,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
	...
	#if S5KHM6SX_MIRROR_FLIP_ENABLE
...
static kal_uint16 read_cmos_eeprom_8(kal_uint16 addr)
{
	...
	iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, S5KHM6SX_EEPROM_READ_ID);
	return get_byte;
}
#endif
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	#ifdef FPT_PDAF_SUPPORT
	sensor_info->PDAF_Support = 2;   ////2 FOR VC, 6for raw
	#else
			     ...
			     UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	// 		S5KHM6SX_read_eeprom((kal_uint16)(*feature_data),
...
{
	LOG_INF("S5KHM6SX_MIPI_RAW_SensorInit in\n");
