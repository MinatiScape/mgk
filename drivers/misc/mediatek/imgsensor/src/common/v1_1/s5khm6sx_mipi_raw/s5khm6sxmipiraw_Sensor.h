 ...
 * Filename:
 * ---------
 *	 s5khm6sxmipiraw_Sensor.h
 *
 ****************************************************************************/
#ifndef _S5KHM6SXMIPI_SENSOR_H
#define _S5KHM6SXMIPI_SENSOR_H
...
extern bool S5KHM6SX_read_eeprom(kal_uint16 addr,	BYTE *data, kal_uint32 size);
