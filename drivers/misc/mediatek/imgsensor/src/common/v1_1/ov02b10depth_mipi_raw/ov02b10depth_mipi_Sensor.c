...
#include "ov02b10depth_mipi_Sensor.h"

/*********************Modify Following Strings for Debug********************/
#define PFX "OV02B10depth_camera_sensor"
#define LOG_1 cam_pr_debug("OV02B10depth,MIPI 1LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10DEPTH_SENSOR_ID,
			...
			do {
				...
				*sensor_id = return_sensor_id()+1;
				if (*sensor_id == imgsensor_info.sensor_id) {
					printk("OV02B10depth i2c write id: 0x%x, sensor id: 0x%x\n",
						imgsensor.i2c_write_id, *sensor_id);
					return ERROR_NONE;
				}
				printk("OV02B10depth Read sensor id fail, write id: 0x%x, id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				retry_cnt--;
			} while (retry_cnt > 0);
			i++;
...
UINT32 OV02B10DEPTH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
