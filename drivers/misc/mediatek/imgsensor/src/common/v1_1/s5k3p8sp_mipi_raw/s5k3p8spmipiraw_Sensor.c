...
#define S5K3P8SP_EEPROM_READ_ID  0xA0
#define S5K3P8SP_EEPROM_WRITE_ID 0xA1
...
static __maybe_unused kal_uint16 read_cmos_eeprom_8(kal_uint16 addr)
{
	...
	iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, S5K3P8SP_EEPROM_READ_ID);
	return get_byte;
}
