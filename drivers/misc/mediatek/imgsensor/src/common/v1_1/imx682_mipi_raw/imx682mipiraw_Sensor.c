...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{9248, 6944, 2064, 2032, 5120, 2880, 1280, 720,
	0, 0, 1280, 720,  0,  0, 1280, 720}, // hs_video reg_E 2312x1304 @120fps
...
/* ITD: Modify Dualcam By Jesse 190924 End */
		...
		case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
			...
			if ((void *)(uintptr_t) (*(feature_data + 1)) != NULL) {
				ret1=copy_to_user((MUINT32 *)(*(feature_data + 1)),imx682_ana_gain_table, sizeof(imx682_ana_gain_table));
			}
			break;
		default:
			break;
