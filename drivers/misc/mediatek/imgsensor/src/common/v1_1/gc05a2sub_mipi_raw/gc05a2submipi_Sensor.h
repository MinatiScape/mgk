...
#define GC05A2SUB_OTP_FOR_MTK 1
#if GC05A2SUB_OTP_FOR_MTK
#define GC05A2SUB_OTP_DATA_DUMP 1
#define GC05A2SUB_OTP_MODULE_ADDR 0x2000// flag addr
#define GC05A2SUB_OTP_MODULE_SIZE (14+2)//flag+data+checksum
#define GC05A2SUB_OTP_AWB_ADDR 0x2170// flag addr
#define GC05A2SUB_OTP_AWB_SIZE (16+2)//flag+data+checksum
#define GC05A2SUB_OTP_LSC_ADDR 0x2310// flag addr
#define GC05A2SUB_OTP_LSC_SIZE (1868+2)//flag+data+checksum
#define GC05A2SUB_OTP_AF_ADDR 0xD250// flag addr
#define GC05A2SUB_OTP_AF_SIZE (14+2)//flag+data+checksum
...
struct imgsensor_otp_info_struct {
	...
	kal_uint8  af_flag;
	kal_uint8  af_macro_h;
	kal_uint8  af_macro_l;
	kal_uint8  af_inf_h;
	kal_uint8  af_inf_l;
