...
#define AW36515_DTNAME_I2C "mediatek,flashlights_aw36515"
#endif
#define AW36515_NAME "flashlights_aw36515"
...
#define AW36515_LEVEL_TORCH          6 //always in torch mode  // prize modify by zhuzhengjiang 


#define CONFIG_PRIZE_SOFT_LED_ENABLE 1
#define AW36515_DEBUG(format, args...) printk(KERN_WARNING format, ##args)
...
static ssize_t device_soft_torch_value_show(struct device *dev,
                ...
                char *buf)
{
	printk("aw36515 cur_soft_torch_status=%d\n", cur_soft_torch_status);
                ...
                const char *buf, size_t size)
{
	...
	printk("aw36515 %s ON/OFF value = %d:\n ", cur_soft_torch_status);
	if(sscanf(buf, "%u", &cur_soft_torch_status) != 1)
	{
		printk("aw36515Invalid values\n");
		return -EINVAL;
	}
	...
	if(1==cur_soft_torch_status)
	{
		...
		//aw36515_set_level(AW36515_CHANNEL_CH1, 1);
	  //printk("aw36515_set_level[AW36515_CHANNEL_CH1]=%d\n",aw36515_timeout_ms[AW36515_CHANNEL_CH1]);
		//if (aw36515_timeout_ms[AW36515_CHANNEL_CH1]) {
		//	printk("aw36515_timeout_ms[AW36515_CHANNEL_CH1]=%d\n",aw36515_timeout_ms[AW36515_CHANNEL_CH1]);
		//	ktime =ktime_set(aw36515_timeout_ms[AW36515_CHANNEL_CH1] / 1000,
		//	(aw36515_timeout_ms[AW36515_CHANNEL_CH1] % 1000) * 1000000);
		//	aw36515_timer_start(AW36515_CHANNEL_CH1, ktime);
			
		//   }
		   aw36515_enable(AW36515_CHANNEL_CH1);
		   aw36515_set_level_ch1(6);
		
	}else{
			aw36515_disable(AW36515_CHANNEL_CH1);
			aw36515_timer_cancel(AW36515_CHANNEL_CH1);
			aw36515_set_level_ch1(0);
...
static ssize_t device_soft_torch2_value_show(struct device *dev,
                ...
                char *buf)
{
	printk("aw36515 cur_soft_torch2_status=%d\n", cur_soft_torch2_status);
	return sprintf(buf, "%u\n", cur_soft_torch2_status);
}
                ...
                const char *buf, size_t size)
{
	...
	if(1==cur_soft_torch2_status)
	{
	  ...
	  //printk("aw36515_set_level[AW36515_CHANNEL_CH1]=%d\n",aw36515_timeout_ms[AW36515_CHANNEL_CH1]);
		...
		//   }
		   aw36515_enable(AW36515_CHANNEL_CH2);
		   aw36515_set_level_ch2(6);
		
	}else{
			aw36515_disable(AW36515_CHANNEL_CH2);
			aw36515_timer_cancel(AW36515_CHANNEL_CH2);
			aw36515_set_level_ch2(0);
