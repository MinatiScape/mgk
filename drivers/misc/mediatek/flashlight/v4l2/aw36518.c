...
//prize add by chenwenhui 20240510 for sts KE start
#define Enable_Cooling 0
//prize add by chenwenhui 20240510 for sts KE end
...
static int aw36518_mode_ctrl(struct aw36518_flash *flash)
{
	...
	case V4L2_FLASH_LED_MODE_NONE:
		pr_info("%s V4L2_FLASH_LED_MODE_NONE\n");
		rval = regmap_update_bits(flash->regmap,
					  REG_ENABLE, 0x0C, MODE_SHDN);
		break;
	case V4L2_FLASH_LED_MODE_TORCH:
		pr_info("%s V4L2_FLASH_LED_MODE_TORCH\n");
		rval = regmap_update_bits(flash->regmap,
					  REG_ENABLE, 0x0C, MODE_TORCH);
		break;
	case V4L2_FLASH_LED_MODE_FLASH:
		pr_info("%s V4L2_FLASH_LED_MODE_FLASH\n");
		rval = regmap_update_bits(flash->regmap,
...
//	aw36518_pinctrl_set(flash, AW36518_PINCTRL_PIN_HWEN, AW36518_PINCTRL_PINSTATE_HIGH);
	...
	if((reg_val&0x02) != 0){
		pr_info("aw36518 reset OVP flag\n");
		rval = regmap_update_bits(flash->regmap, REG_FLAG2, 0x02, 0x00);
	}  
