...
#define FTS_Y_MAX_DISPLAY_DEFAULT           (1612 - 1)
...
#endif
#if FTS_SPICSB_PINCTRL_EN
		struct pinctrl *spicsb_pinctrl;
		struct pinctrl_state *spicsb_pins_active;
		struct pinctrl_state *spicsb_pins_suspend;
		struct pinctrl_state *spicsb_pins_release;
#endif
