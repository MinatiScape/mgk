...
//drv Change the cs_setup time to 200ns moment ft8725 requires the time to be 200ns-pzp-20240523-start
struct spi_delay cs_setup_delay = {
    .value = 200,  // 20 ns
    .unit = SPI_DELAY_UNIT_NSECS
};
//drv Change the cs_setup time to 200ns moment ft8725 requires the time to be 200ns-pzp-20240523-end
/*****************************************************************************
* TP Driver
*****************************************************************************/
