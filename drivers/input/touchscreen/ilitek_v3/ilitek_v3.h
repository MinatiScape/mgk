...
#define EAR_PHONE_NOTIFIER_CALLBACK	ENABLE
...
/* prize add by zhanghuimin for SN339D-1757 start */
	...
	struct workqueue_struct *earphone_notify_wq;
	struct work_struct	update_earphone;
	int earphone_plug_status;
#endif
/* prize add by zhanghuimin for SN339D-1757 end */
#endif
#ifdef ROI
...
extern void ili_config_spi(int status);
