...
#define TOUCH_SCREEN_X_MAX			1080//720
#define TOUCH_SCREEN_Y_MAX			2460//1440
...
/*  add_for_charger_end  */
	...
	struct pinctrl *pin_spi_pinctrl;
	struct pinctrl_state *ctp_pin_spi_mode_default;
	/* drv added by chenjiaxi, improve spi driving capability, end */
};
